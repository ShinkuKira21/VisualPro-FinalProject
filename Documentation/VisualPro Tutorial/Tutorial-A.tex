...
\label{sec:terminology}
    ...
    \subsection{What is a method?}
        A method is found within a class that provides functionality to interact with neighbor methods and variables, child class methods and variables or object methods and variables (dependent on the access modifier).

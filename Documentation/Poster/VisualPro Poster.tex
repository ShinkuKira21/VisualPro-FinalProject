...
\vspace{9.5cm}
\Huge \color{ku} \textbf{Unnecessarily Complicated Research Title} \color{Black}\\ % Title
\huge\textit{An Exploration of Complexity}\\[1cm] % Subtitle
\Large \textbf{Rud Vibjerg Faden}\\[0.5cm] % Author(s)
\Large Department of Economics\\[0.4cm] % University/organization

...
\label{sec:literatureReview}
	...
	\section{Testing Functionality}
		...
		\begin{center}
			If tests were underway and a beginner new to programming follows a detailed guide to start learning how the software works and the software slows down or even crashes on the user, the user may find discomfort or trust issues learning to use the software.
		\end{center}
		
		The point proves that before any User Usability testing within the VisualPro's UI, it is essential to make sure the software can run under any given load and provides functionality to the intention.
...
Qualitative Research focuses on satisfaction experience, behaviours and intellect. A requirement of a complete analysis to check credibility. A survey inviting a mixed background of participants would support the research. 

Descriptive Research uses statistical data to analyse any design flaws within a project using official data. For accurate data that is relevant, the most up-to-date information dependent upon the scenario is suitable.

Fundamental Research allows multiple research methods to correlate the information in a design plan. The two main research methods that suit VisualPro's project is Quantitative and Qualitative research methods. These methods are a suitable way to analyse data to aid the construction of the project's User Interface, User Experience, and User Usability.

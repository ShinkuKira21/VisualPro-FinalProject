    ...
    \section{Literature Review}
      \subsection{User Interface and User Experience}
        ...
        \subsubsection{User Interface}
          To get some ideas for the user interface, the Journal `Evaluation of a UML-Based Versus an IEC 61131-3-Based Software Engineering Approach for Teaching PLC Programming' writting by Birgit Vogel-Heuser, Martin Obermeier, Steven Braun, Kerstin Sommer, Fabian Jobst, and Karin Schweizer~\cite{205202} and the Journal `Design Issues and First Experiences with a Visual Database Editor for the extended NF$^{2}$-Data Model', author(s):- K. K${\ddot{u}}$spert, J. Teuhola and L. Wegner. These Journals cover Unified Modeling Language (UML). The UML concept is used in relationship diagrams in databases and Visual Scripting. 

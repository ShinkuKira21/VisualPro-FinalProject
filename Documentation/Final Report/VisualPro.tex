...
\label{chap:designAndFeedback}
	...
	\chapter{Evaluation of Feedback}
		\section{Programmer Planner vs. VisualPro}
			...
			Figure~\ref{fig:EoF-SQ-A5}: `Does the software provide enough tuitive ways to create structure?', half of the respondents chose `Yes', and the other half chose `No', demonstrating that the software could do with more functionality to provide a more structured environment to prevent a great UX and User Usability environment.
